...
profile:
  ...
  #   <!--<p><i class="material-icons">email</i> <a href="mailto:Fan@di.uniroma1.it">Fan@di.uniroma1.it</a></p>
...
Before TeleAI, I was a postdoc at [Fudan University](https://cs.fudan.edu.cn) (2023-2024), where I focus on **AI applications for database systems**. Prior to that, I had been working for [Microsoft](https://www.microsoft.com/en-us/aprd/aboutus/team-cai) as a senior engineer nearly seven years (2016-2023), gaining extensive experience in (Windows) **system development** and **Azure AI services** (now part of [Microsoft Foundry](https://azure.microsoft.com/en-us/products/ai-foundry/tools)). Earlier in my career, I worked as a software engineer at EMC<sup>2</sup> (now part of [DELL Technologies](https://www.dell.com/en-ae/lp)) (2015-2016), specializing in **cloud storage technology**.

I received my Ph.D in CS from [FDU](https://cs.fudan.edu.cn) under the guidance of Prof. [X. Sean Wang](https://daslab.fudan.edu.cn/61/83/c26852a287107/page.htm) (and Prof. Zhenying He) (2017-2023), and also hold a B.Eng. degree from [YSU](https://english.ysu.edu.cn) in 2013. 
...
From September 2009 to January 2023, I have been <em>PhD student</em> at [University of Naples "Federico II"](http://www.unina.it) working under the supervision of [Prof. Aniello Murano](http://people.na.infn.it/~murano/).
On January 2023, I joined [Fudan University](https://cs.fudan.edu.cn/) as <em>Postdoctoral Research Assistant</em>, working with [Prof. X. Sean Wang](https://daslab.fudan.edu.cn/61/83/c26852a287107/page.htm).
