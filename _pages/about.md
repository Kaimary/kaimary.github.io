...
Before TeleAI, I was a postdoc at [Fudan University](https://cs.fudan.edu.cn), where I focus on **AI applications for database systems**. Pior to that, I worked for [Microsoft](https://www.microsoft.com/en-us/aprd/aboutus/team-cai) as a senior engineer, gaining extensive experience in (Windows) **system development** as well as (Azure) **AI services**, and earlier served as a software engineer at EMC<sup>2</sup> (now part of [DELL Technologies](https://www.dell.com/en-ae/lp)), specializing in **cloud storage technology**.
