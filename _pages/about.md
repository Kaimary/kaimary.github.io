...
Before TeleAI, I was a postdoc at [Fudan University](https://cs.fudan.edu.cn), where I focus on **AI applications for database systems**. Pior to that, I worked for [Microsoft](https://www.microsoft.com/en-us/aprd/aboutus/team-cai) as a senior engineer, gaining extensive experience in (Windows) **system development** as well as **Azure AI services** (now part of [Microsoft Foundry](https://azure.microsoft.com/en-us/products/ai-foundry/tools)), and earlier served as a software engineer at EMC<sup>2</sup> (now part of [DELL Technologies](https://www.dell.com/en-ae/lp)), specializing in **cloud storage technology**.

I received my Ph.D in CS from [FDU](https://cs.fudan.edu.cn) under the guidance of Prof. [X. Sean Wang](https://daslab.fudan.edu.cn/61/83/c26852a287107/page.htm) (and Prof. Zhenying He), and also hold a B.Eng. degree from [YSU](https://english.ysu.edu.cn). 
